...
function App() {
  ...
  return <div className="site-shell">
    ...
    <footer><div className="container footer-grid"><div><Logo /><p>Ideias ganham forma.<br />Detalhes ganham vida.</p></div><div><b>Navegue</b><a href="#solucoes">Soluções</a><a href="#projetos">Projetos</a><a href="./catalogo.html">Catálogo</a><a href="#processo">Processo</a></div><div><b>Contato</b><a href={INSTAGRAM} target="_blank" rel="noreferrer"><Instagram /> @rrlimpressoes3d</a><span>Orçamentos via Direct</span></div></div><div className="container copyright"><span>© 2026 RRL Impressões 3D</span><span>Feito com precisão, camada por camada.</span></div></footer>
